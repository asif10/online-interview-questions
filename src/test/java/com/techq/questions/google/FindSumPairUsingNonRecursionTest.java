 ...
 * 11/05/2020 20:13
 */
class FindSumPairUsingNonRecursionTest {
    ...
    private static Arguments containsASumOf5() {
        return Arguments.of("contains 3,2", true, new int[]{1, 2, 3, 4}, 5);
    }
    ...
    void shouldFindPositionInArray(String description, boolean expectedResponse, int[] values, int sum) {
        boolean position = new FindSumPairUsingNonRecursion().findPairOfSum(values, sum);
