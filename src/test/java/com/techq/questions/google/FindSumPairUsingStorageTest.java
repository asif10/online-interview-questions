 ...
 * 11/05/2020 20:27
 */
class FindSumPairUsingStorageTest {
    ...
    private static Arguments containsASumOf5() {
        return Arguments.of("contains 3,2", true, new int[]{3, 1, 2, 4}, 5);
    }
    ...
    void shouldFindPositionInArray(String description, boolean expectedResponse, int[] values, int sum) {
        boolean position = new FindSumPairUsingStorage().findPairOfSum(values, sum);
